...
function NewMediaIndex() {
    ...
    <div className={styles.backgroundColor}>
        <Container>
            <Head>
                <title>{t('title_05')} - Julio Montas</title>
                ...
                <meta property='og:title' content='CURRENTS: TRANSLATIONS - New Media' />
                <meta name='twitter:title' content='CURRENTS: TRANSLATIONS - New Media' />
