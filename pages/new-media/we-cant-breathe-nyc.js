...
function NewMediaIndex() {
    ...
    <div className={styles.backgroundColor}>
        <Container>
            <Head>
                <title>{t('title_03')} - Julio Montas</title>
                ...
                <meta property='og:title' content="We Can't Breathe NYC - New Media" />
                <meta name='twitter:title' content="We Can't Breathe NYC - New Media" />
